    ...
    <div class="wst-body"> 
      ...
      <button class='wst-btn-query' onclick='javascript:queryOnSale()'>查询</button>
        ...
        <div class='wst-tbar-group'>
           ...
           <a href='javascript:goodsSet("isBest","queryUnSaleByPage")'><span class='best btn'></span>今日疯抢</a>
        ...
        <table class='wst-list'>
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <a href="javascript:toEditGoods(<?php echo ($vo['goodsId']); ?>,'queryOnSaleByPage',<?php echo ($p); ?>)" class='btn edit' title='编辑'></a>
