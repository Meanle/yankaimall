            ...
            <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- 一级分类start -->
             <tr id='tr_0_<?php echo ($i); ?>' class="tr_0" isLoad='1'>
               ...
               <?php else: ?>
                   ...
                   <ul class="dropdown-menu" role="menu">
					  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(1,<?php echo ($vo['catId']); ?>)">精选促销</a></li>
					  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(0,<?php echo ($vo['catId']); ?>)">不精选促销</a></li>
				   </ul>
               </div>
               </td>
             ...
             <?php if($vo['childNum'] > 0): if(is_array($vo['child'])): $i2 = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i2 % 2 );++$i2;?><tr id='tr_0_<?php echo ($i); ?>_<?php echo ($i2); ?>' class="tr_0_<?php echo ($i); ?>" isLoad='1'>
	               ...
	               <?php else: ?>
	                   ...
	                   <ul class="dropdown-menu" role="menu">
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(1,<?php echo ($vo2['catId']); ?>)">精选促销</a></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(0,<?php echo ($vo2['catId']); ?>)">不精选促销</a></li>
					   </ul>
	               </div>
	               </td>
                 ...
                 <?php if($vo2['childNum'] > 0): if(is_array($vo2['child'])): $i3 = 0; $__LIST__ = $vo2['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i3 % 2 );++$i3;?><tr id='tr_0_<?php echo ($i); ?>_<?php echo ($i2); ?>_<?php echo ($i3); ?>' class="tr_0_<?php echo ($i); ?>_<?php echo ($i2); ?>" isLoad='1'>
	               ...
	               <?php else: ?>
	                   ...
	                   <ul class="dropdown-menu" role="menu">
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(1,<?php echo ($vo3['catId']); ?>)">精选促销</a></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:toggleIsFloor(0,<?php echo ($vo3['catId']); ?>)">不精选促销</a></li>
					   </ul>
	               </div>
	               </td>
		               <td>
