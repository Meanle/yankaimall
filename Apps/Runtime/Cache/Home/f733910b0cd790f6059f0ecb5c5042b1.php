...
<div class="page">
    <div class="content" id="oders-entity">
        <div class="buttons-row">
            <a href="#tab1" class="tab-link button tab1 <?php if($type == 1): ?>active<?php endif; ?>">待付款</a>
            <a href="#tab2" class="tab-link button tab2 <?php if($type == 2): ?>active<?php endif; ?>">待发货</a>
            <a href="#tab3" class="tab-link button tab3 <?php if($type == 3): ?>active<?php endif; ?>">待收货</a>
            <a href="#tab4" class="tab-link button tab4 <?php if($type == 4): ?>active<?php endif; ?>">待评价</a>
            <a href="#tab5" class="tab-link button tab5">已完成</a>
        </div>
        <div class="tabs">
            <div id="tab1" class="tab <?php if($type == 1): ?>active<?php endif; ?>">
                <div class="content-block">
                </div>
            </div>
            <div id="tab2" class="tab <?php if($type == 2): ?>active<?php endif; ?>">
                <div class="content-block">
                </div>
            </div>
            <div id="tab3" class="tab <?php if($type == 3): ?>active<?php endif; ?>">
                <div class="content-block">
                </div>
            </div>
            <div id="tab4" class="tab <?php if($type == 4): ?>active<?php endif; ?>">
                <div class="content-block">
                </div>
            </div>
