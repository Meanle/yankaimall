    ...
    <div class="content page-home infinite-scroll page-special" id='list-page'>
        ...
        <div class="list">
            <ul id="special-list" class="list_sort_list collect_list">
                <?php if(is_array($catList)): foreach($catList as $k4=>$vo4): if($vo4['catName'] == 分类): if(is_array($vo4['catChildren'])): foreach($vo4['catChildren'] as $k5=>$vo5): if(is_array($vo5['goods'])): foreach($vo5['goods'] as $k6=>$vo6): ?><li>
                                    <div class="sell-goods">
                                        <a class="" href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$vo6['goodsId']));?>">
                                        ...
                                        <!--<div class="vip-price">
                                            <p><em>￥</em><?php echo ($vo6['vipPrice']); ?></p>
                                        </div>-->
                                        <a class="hei_si" href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$vo6['goodsId']));?>" style="display: block;">查看详情</a>
                                        <!--<p class="pl"><em>5人评价</em>，<em>好评率100%</em></p>-->
                                    </div>
                                </li><?php endforeach; endif; endforeach; endif; endif; endforeach; endif; ?>
            </ul>
        </div>
        <!--当没有商品时显示-->
