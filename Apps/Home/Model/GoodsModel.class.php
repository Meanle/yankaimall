...
class GoodsModel extends BaseModel {
	...
	public function getGoodsList($obj){
		...
		$sql = " FROM __PREFIX__goods g 
				...
				left join __PREFIX__goods_cats gc on gc.catId= g.goodsCatId3
		...
		$pages = $this->pageQuery($sqla . $sql . $where, $pcurr, 50);
	...
	public function getAttrs($obj){
		...
		$goods = array();
		//获取规格属性
		$sql = "select ga.id,ga.attrVal,ga.attrPrice,ga.attrStock,a.attrId,a.attrName,a.isPriceAttr,a.createTime
    ...
    public function queryOnSaleByPageOutput(){
        ...
        $sql = "select g.goodsSn,g.goodsSn,g.goodsName,g.marketPrice,g.shopPrice,g.activePrice,g.goodsStock,g.saleCount,g.goodsUnit,g.goodsKeywords,g.goodsSpec,g.isRecomm,g.isHot,g.isBest,g.isNew,gc.catName,sc.catName as shopCatName,g.brandId,g.goodsDesc,ga.isRecomm as attIsRecomm from __PREFIX__goods g
